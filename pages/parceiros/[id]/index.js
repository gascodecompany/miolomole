...
// export async function getStaticPaths(){
  // const res = await axios.get(`${process.env.NEXT_PUBLIC_API_URL}/api/parceiros`)
...
// export async function getStaticProps({ params }) {
  // const { id } = params;
  // const res = await axios.get(`${process.env.NEXT_PUBLIC_API_URL}/api/parceiros`, { data: { _id: id } })
