...
export default function PartnerForm(props){
  ...
  //   setMessage('')
  //   if(!partner){
  //     axios.post(`${process.env.NEXT_PUBLIC_API_URL}/api/parceiros`, { ...fieldsValue })
  //       .then((res) => { 
  //         if(res.status === 200) {
  ...
  //   } else {
  //     axios.put(`${process.env.NEXT_PUBLIC_API_URL}/api/parceiros`, Object.assign({ _id: partner._id } ,{ ...fieldsValue }))
  //       .then((res) => { 
  //         if(res.status === 200) {
